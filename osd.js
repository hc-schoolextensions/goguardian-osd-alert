...
`;
  ...
  document.getElementById('osddivheader').addEventListener('mouseup', function () {
    if (document.getElementById('osddivcontent').style.display == "none") {
      document.getElementById('osddivcontent').style.display = "block";
    } else {
      document.getElementById('osddivcontent').style.display = "none";
    }
  });
}